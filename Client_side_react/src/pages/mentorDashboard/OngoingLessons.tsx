...
const OngoingLessons: React.FC<Props> = ({ className }) => {
  return (
    <Card className="" style={{ boxShadow: '1px 2px 9px #0000003D', marginTop: '0px', backgroundColor: 'white', width: '200px', height: '150px' }}>
      ...
      <div className='card-header align-items-center border-0 '>
        <h3 className='card-title m-7 flex items-center'>
          ...
          <span style={{ color: '#05445E', fontSize: '30px', marginRight: '96px', marginTop: '-20px', height: '14px' }}>5</span>

        </h3>
        <div className='card-toolbar mt-5'>
          <span style={{ color: '#3699ff', fontFamily: 'Segoe UI', fontSize: '20px', fontWeight: 'lighter', marginLeft: '30px' }}>Ongoing Lessons</span>
        </div>
      </div>
      {/* end::Body */}
    </Card>

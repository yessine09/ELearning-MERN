...
import trainingDataContext from "../../../../../../features/auth/components/profiling/contexts/trainingDataContext";
import { TrainingSchema } from "../../../../../../features/auth/yupSchemas";
...
export default function TrainingInput({ establishment, local, specialty, degree, startDate, endDate, index }: trainingProps) {

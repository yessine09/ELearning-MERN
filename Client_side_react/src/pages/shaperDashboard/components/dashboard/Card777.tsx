...
const Card777: React.FC<Props> = ({className}) => {
  return (
    
    <Card style={{
      boxShadow: '1px 2px 9px #0000003D',borderRadius: '10px', fontFamily: 'Segoe UI', backgroundColor: 'white', width: '180px', height: '160px', marginLeft: '110px'
  }}>
      {/* begin::Header */}
      <div className=' '>

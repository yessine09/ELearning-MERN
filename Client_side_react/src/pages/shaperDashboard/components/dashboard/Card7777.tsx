...
const Card7777: React.FC<Props> = ({className}) => {
  return (
    <Card style={{
      boxShadow: '1px 2px 9px #0000003D',borderRadius: '10px', fontFamily: 'Segoe UI', backgroundColor: 'white', width: '220px', height: '160px', marginLeft: '210px'
     }}>
      {/* begin::Header */}
      <div className=' '>

          <h3 className='mt-3' style={{ fontWeight:'bold',color: '#05445E', fontSize: '15px', fontFamily: 'Segoe UI',marginLeft:'25px' }}>
      ...
      {/* end::Header */}
      {/* begin::Body */}
      <div className='card-body pt-5 ml-6'>

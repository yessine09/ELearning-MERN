...
export default function ManageComponent({ onClick, handleEdit, handleDelete }: ManageComponentProps) {
    ...
    return (
        ...
        <div className="d-flex flex-column flex-justify-between align-items-center form-control form-control-lg  shadow-sm " style={{ position: 'absolute', right: '10%', top: '1%', height: '100px', width: '100px' }}>
            ...
            <button className="text-dark-blue" style={{ border: 'none', backgroundColor: 'transparent', fontFamily: 'Segoe UI', fontWeight: 'bold', fontSize: '15px' }} onClick={handleDelete}>Delete</button>
        </div>
